...
require "lualib/modular_admin/modular_admin" --FMMO admin tools
require "lualib/modular_information/modular_information" --Info windows from FMMO
...
--require "trusted" --Module to add trusted players to a seperate permission group
    -- Equipment module gives player starting items and items on respawn --
require "equipment"
